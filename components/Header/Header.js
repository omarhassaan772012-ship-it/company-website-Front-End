    ...
    return(
        <header>
            ...
            <nav className="nav-menu">
                ...
                {pathname === "/" && <Link href="/services1" className="nav-menu-link service-button">Services</Link>}
                ...
                {pathname === "/aboutus" && <Link href="/services1" className="nav-menu-link">Services</Link>} 
                ...
                {pathname === "/contact" && <Link href="/services1" className="nav-menu-link">Services</Link>}
                ...
                {pathname === "/our-work" && <Link href="/services1" className="nav-menu-link">Services</Link>}
